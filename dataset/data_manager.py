...
def get_dataset(cfg):
    ...
    cfg.DATASET.DOMAIN_CLASS_COUNTS = train_dataset.domain_class_counts(
        len(cfg.DATASET.SOURCE_DOMAINS),
        cfg.DATASET.NUM_CLASSES,
    ).tolist()
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True,
                              num_workers=num_worker, drop_last=drop_last, pin_memory=True)
